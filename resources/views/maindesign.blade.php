...
<head>
    ...
    <link rel="shortcut icon" href="front_end/images/lobo.png" type="image/x-icon">
        ...
        <header class="header_section">
            <nav class="navbar navbar-expand-lg custom_nav-container ">
                <a class="navbar-brand" href="index.html">
                    <span>
                        Shop<span style="font-weight:300;">Ease</span>
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        <div class="detail-box">
                                            ...
                                            <p>
                                               your one-stop destination for trendy gifts and everyday essentials!
                                                Discover a wide range of products that combine quality, style, and affordability.
                                                Whether you’re shopping for yourself or a loved one, we make online shopping simple, secure, and enjoyable.
                                            </p>
                                            <a href="">
                                                Contact Us
                                            </a>
